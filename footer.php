	<div class="preso-footer ui-footer ui-bar-a ui-footer-fixed slideup" data-defaults="true">
		<form class="preso-follow-checkbox-wrapper">
			<div class="ui-checkbox preso-follow-checkbox-wrapper">
				<label for="follow" class="ui-btn ui-corner-all ui-btn-inherit ui-btn-icon-left ui-checkbox-off">Follow Along
				</label>
